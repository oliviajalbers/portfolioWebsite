export default function Home() {
  return (
    <section className="text-left mt-20">
      ...
      <br></br>
      <div>
        <h2 className="text-xl text-gray-400 tracking-wide font-heading">Experience</h2>
        <h3 className="text-base text-gray-500 tracking-wide">Software Engineer | Oracle | Austin, TX</h3>
        <h3 className="text-base text-gray-500 tracking-wide">January 2026 - Present</h3>
        <ul className="list-disc pl-5 space-y-1">
          <li className="text-base text-gray-500 tracking-wide">Build and maintain automated tests for a web application improving reliability and efficiency</li>
          <li className="text-base text-gray-500 tracking-wide">Collaborate with other engineers to develop automation tools across cloud operations </li>
          <li className="text-base text-gray-500 tracking-wide">Earned Oracle AI Foundations Certification, strengthening ability to apply AI/ML concepts within cloud-based solutions</li>
        </ul>
         <h3 className="text-base text-gray-500 tracking-wide">Software Development Intern | Hurley Piano | Austin, TX</h3>
        <h3 className="text-base text-gray-500 tracking-wide">August 2024 - December 2024</h3>
        <ul className="list-disc pl-5 space-y-1">
          <li className="text-base text-gray-500 tracking-wide">Developed a backend for a Godot game designed to teach piano to children with special needs, incorporating features 
            for leaderboards and user account management</li>
        </ul>
        <h3 className="text-base text-gray-500 tracking-wide">Software Engineer Intern | Oracle | Austin, TX</h3>
        <h3 className="text-base text-gray-500 tracking-wide">May 2024 - August 2024</h3>
        <ul className="list-disc pl-5 space-y-1">
          <li className="text-base text-gray-500 tracking-wide">Collaborated with other engineers on the Service Automation Development Team within Cloud Operations to help design, 
            build, and maintain internal tools that streamline workflows and enhance efficiency
          </li>
          <li className="text-base text-gray-500 tracking-wide">Actively participated in Agile Scrum practices, including daily stand-ups and weekly scrum meetings to ensure timely 
            project delivery and effective team collaboration
          </li>
          <li className="text-base text-gray-500 tracking-wide">Contributed to the development of a web application, both frontend and backend, using Python, JavaScript, Angular, HTML, 
            and SQL
          </li>
          <li className="text-base text-gray-500 tracking-wide">Created comprehensive documentation for a PL/SQL package used in a web application detailing functional specifications 
            and usage instructions to facilitate better understanding and maintenance
          </li>
        </ul>
      </div>
      <br></br>
